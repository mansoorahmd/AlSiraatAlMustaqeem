// Script / encoding helpers — port of quran_api/normalize.py. constants.ts is
// the single source of truth for the Buckwalter tables.

import { BUCKWALTER2UNICODE, UNICODE2BUCKWALTER } from "./constants.js";

// Arabic diacritics (harakat, tanwin, shadda, sukun, dagger alif, …).
// Ranges match the Python regex [ؐ-ًؚ-ٰٟۖ-ۭ] exactly:
