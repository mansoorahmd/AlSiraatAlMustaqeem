// Morphology-pattern similarity — on-device port of
// server/src/similarity/morphology.ts. IDF-weighted cosine over POS
// bigrams+trigrams + longest common POS run.

import type { Db } from "../data/db";
import { longestCommonRun } from "./lexical";
