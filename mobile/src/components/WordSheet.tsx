...
const styles = StyleSheet.create({
  ...
  sheetArabic: { fontSize: 34, paddingBottom: 10, includeFontPadding: true, color: colors.ink, textAlign: "center", writingDirection: "rtl", fontFamily: font.arabic },
  ...
  waznPattern: { color: colors.gold, fontSize: 26, paddingBottom: 10, includeFontPadding: true, fontFamily: font.arabic, writingDirection: "rtl" },
  waznRadicals: { color: colors.inkSoft, fontSize: 15, includeFontPadding: true, writingDirection: "rtl", fontFamily: font.arabic },
  ...
  variantArabic: { color: colors.ink, fontSize: 24, paddingBottom: 6, includeFontPadding: true, writingDirection: "rtl", flex: 1, fontFamily: font.arabic },
