...
const styles = StyleSheet.create({
  ...
  sheetArabic: { fontSize: 40, lineHeight: 78, color: colors.ink, textAlign: "center", writingDirection: "rtl", fontFamily: font.arabic },
  ...
  waznPattern: { color: colors.gold, fontSize: 30, lineHeight: 52, fontFamily: font.arabic, writingDirection: "rtl" },
  ...
  variantArabic: { color: colors.ink, fontSize: 26, lineHeight: 50, writingDirection: "rtl", flex: 1, fontFamily: font.arabic },
